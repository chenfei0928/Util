 ...
 *
 * @author MrFeng
 * @date 2019-05-24 15:24
 */
public abstract class ViewBackgroundTarget<T extends View, Z> implements Target<Z> {
    private static final String TAG = "ViewBackgroundTarget";
    @IdRes
     ...
     * size from the {@link ViewGroup.LayoutParams} or valid non-zero values for {@link View#getWidth()} and
     * {@link View#getHeight()}.
     *
     ...
     *
     * <p>If the {@link ViewGroup.LayoutParams} of the wrapped {@link View} are set to fixed sizes, they will
     ...
     * {@link ViewGroup.LayoutParams}. If one or both of the params width and height are less than or equal to
    ...
    static final class SizeDeterminer {
        ...
        @Nullable
        private ViewBackgroundTarget.SizeDeterminer.SizeDeterminerLayoutListener layoutListener;
        ...
        void getSize(@NonNull SizeReadyCallback cb) {
            ...
            if (layoutListener == null) {
                ...
                layoutListener = new ViewBackgroundTarget.SizeDeterminer.SizeDeterminerLayoutListener(this);
        ...
        private int getTargetHeight() {
            ...
            return getTargetDimen(view.getHeight(), layoutParamSize);
        }
        ...
        private int getTargetDimen(int viewSize, int paramSize) {
            ...
            int adjustedParamSize = paramSize;
        ...
        private static final class SizeDeterminerLayoutListener
            ...
            private final WeakReference<ViewBackgroundTarget.SizeDeterminer> sizeDeterminerRef;

            SizeDeterminerLayoutListener(@NonNull ViewBackgroundTarget.SizeDeterminer sizeDeterminer) {
            ...
            public boolean onPreDraw() {
                ...
                ViewBackgroundTarget.SizeDeterminer sizeDeterminer = sizeDeterminerRef.get();
