package com.chenfei.util.qrcode
    ...
    companion object {
        ...
        fun createQRImage(
            ...
            try {
                ...
                return bitmap != null && bitmap.compress(
        ...
        @JvmStatic
        fun createQRBitmap(content: String?, widthPix: Int, heightPix: Int): Bitmap? {
            if (content.isNullOrBlank() || widthPix == 0 || heightPix == 0) {
                return null
            }

            return try {
                // 配置参数
                val hints = androidx.collection.ArrayMap<EncodeHintType, Any>(3)
