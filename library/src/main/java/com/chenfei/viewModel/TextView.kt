...
import com.chenfei.util.kotlin.contains
...
private fun TextView.setShrinkTextInternal(text: String, lastLinePadding: Int, maxLines: Int) {
    ...
    // 检查多少字可以在该行空下对应宽度
    val indexEndTrimmedRevised = binaryMeasureTextSafeWidthForTextEndIndex(paint, text, lineStart, targetWidth)
 ...
 */
private fun binaryMeasureTextSafeWidthForTextEndIndex(paint: TextPaint, text: String, lineStart: Int, safeWidth: Float): Int {
