 ...
 */
public class FitWindowRelativeLayout extends RelativeLayout {
    private final boolean fitStatusBar;

    public FitWindowRelativeLayout(Context context) {
        this(context, null);
    }

    public FitWindowRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FitWindowRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
